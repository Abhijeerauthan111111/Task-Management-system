        ...
        <div class="row">
            <div class="mt-5 pt-5">
                <div class="col-md-3 m-auto shadow" id="register-home-page">
                    <center><h3 class="py-3">User Registration</h3></center>
                    <form action="" method="post">
                        ...
                        <div class="form-group text-center my-3">
                            <input type="submit" name="userRegistration" class="btn border-0 rounded-lg custom-btn log" id="" value="Register">
                        </div>
                    </form>
